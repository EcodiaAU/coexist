...
export default async function SupportPage() {
  ...
  return (
    <main data-eos-id="web/app/get-involved/support/page.tsx#0" data-eos-v="2">
      ...
      <section data-eos-id="web/app/get-involved/support/page.tsx#2" className="border-b border-neutral-200 bg-white">
      ...
      <section data-eos-id="web/app/get-involved/support/page.tsx#8" className="bg-olive-800 text-oncream">
        <div data-eos-id="web/app/get-involved/support/page.tsx#9" className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-24 md:grid-cols-2">
          <Reveal data-eos-id="web/app/get-involved/support/page.tsx#10">
            <p data-eos-id="web/app/get-involved/support/page.tsx#11" className="eyebrow text-sage">For business</p>
            <h2 data-eos-id="web/app/get-involved/support/page.tsx#12" className="mt-4 text-4xl text-oncream sm:text-5xl">Become a corporate partner</h2>
            <p data-eos-id="web/app/get-involved/support/page.tsx#13" className="mt-6 max-w-md text-[15px] leading-relaxed text-oncream/85">
            ...
            <Link data-eos-href="static" data-eos-id="web/app/get-involved/support/page.tsx#14" href="/contact" className="mt-8 inline-block rounded-full bg-oncream px-8 py-3.5 text-[13px] font-semibold uppercase tracking-wider text-olive-900 transition-all duration-300 hover:px-10">
              Start a conversation
            </Link>
          </Reveal>
          <Reveal data-eos-id="web/app/get-involved/support/page.tsx#15" delay={120} className="border-l-2 border-sage pl-8">
            <span data-eos-id="web/app/get-involved/support/page.tsx#16" className="block font-light leading-none text-sage" style={{ fontSize: '4rem', lineHeight: 1 }} aria-hidden="true">&ldquo;</span>
            <blockquote data-eos-id="web/app/get-involved/support/page.tsx#17" className="display-tight -mt-2 text-3xl font-light leading-snug text-oncream sm:text-4xl">
              You&apos;re actually making a difference to the world around you.
            </blockquote>
            <p data-eos-id="web/app/get-involved/support/page.tsx#18" className="label mt-6 text-sage">Sam Lundberg, Co-Exist volunteer</p>
          </Reveal>
        </div>
      </section>

      {/* What your support enables */}
      <section data-eos-id="web/app/get-involved/support/page.tsx#19" className="bg-cream">
        <div data-eos-id="web/app/get-involved/support/page.tsx#20" className="mx-auto max-w-6xl px-6 py-24">
          <p data-eos-id="web/app/get-involved/support/page.tsx#21" className="eyebrow text-primary-600">Where it goes</p>
          <h2 data-eos-id="web/app/get-involved/support/page.tsx#22" className="display-tight mt-3 max-w-2xl text-4xl text-neutral-900 sm:text-5xl">Every dollar does something you can see</h2>
      ...
      <section data-eos-id="web/app/get-involved/support/page.tsx#27" className="border-y border-neutral-200 bg-white">
        <div data-eos-id="web/app/get-involved/support/page.tsx#28" className="mx-auto max-w-6xl px-6 py-16 text-center">
      ...
      {/* Ways to support */}
      <section data-eos-id="web/app/get-involved/support/page.tsx#35" className="bg-white">
        <div data-eos-id="web/app/get-involved/support/page.tsx#36" className="mx-auto max-w-6xl px-6 py-24">
          <p data-eos-id="web/app/get-involved/support/page.tsx#37" className="eyebrow text-primary-600">Ways to support</p>
          <h2 data-eos-id="web/app/get-involved/support/page.tsx#38" className="display-tight mt-3 text-4xl text-neutral-900 sm:text-5xl">More ways to help</h2>
          ...
          <p data-eos-id="web/app/get-involved/support/page.tsx#44" className="mt-12 text-sm text-neutral-400">
