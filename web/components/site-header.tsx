...
export function SiteHeader() {
  ...
  return (
    <header data-eos-id="web/components/site-header.tsx#2" className="sticky top-0 z-50 border-b border-neutral-200/70 bg-cream/85 backdrop-blur text-[#b33a3a] bg-[#b33a3a]">
