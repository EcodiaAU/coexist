    ...
    <div className={`flex flex-wrap items-center gap-3 ${className}`}>
      ...
      >
        ...
        <span className="leading-none">
          <span className="block text-[8px] uppercase tracking-wide opacity-80">Download on the</span>
      ...
      >
        <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden>
          <path d="M3.6 2.4c-.25.26-.4.66-.4 1.18v16.84c0 .52.15.92.4 1.18l.06.05L13 12.06v-.12L3.66 2.35l-.06.05z" fill="#34A853" />
          <path d="M16.5 15.56 13 12.06v-.12l3.5-3.5.08.05 4.15 2.36c1.18.67 1.18 1.77 0 2.45l-4.15 2.36-.08.05z" fill="#FBBC04" />
          <path d="M16.58 15.51 13 12 3.6 21.6c.39.41 1.03.46 1.76.05l11.22-6.14z" fill="#EA4335" />
          <path d="M16.58 8.49 5.36 2.35c-.73-.41-1.37-.36-1.76.05L13 12l3.58-3.51z" fill="#4285F4" />
        </svg>
        <span className="leading-none">
          <span className="block text-[8px] uppercase tracking-wide opacity-80">Get it on</span>
