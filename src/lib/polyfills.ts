...
/*  of these is called - which for a phone-less member is the instant  */
/*  the authed shell + PhoneGate mount. This module MUST be imported   */
/*  first in main.tsx (before any app/vendor code runs). Each polyfill */
/*  installs only when the native method is absent, so modern engines  */
/*  are untouched. Origin: 2026-07-05 phone-gate old-Android crash.    */
/* ------------------------------------------------------------------ */
