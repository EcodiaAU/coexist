...
const SYSTEM_TEMPLATES: TemplateInfo[] = [
  ...
  },
  {
    ...
    // send-email's own subject branches on is_recurring ("Thanks for your
    // recurring donation!"), which a static default cannot express. This is a
    // deliberate approximation, not drift. Saving it unedited DOES pin the
    // non-recurring wording for both cases, so edit with that in mind.
  ...
  /* ------------------------------------------------------------------ *
   * Added 2026-09-15. send-email defines 29 templates and this screen
   * listed 18, so eleven could not be reworded at all. The absence was
   * invisible: the screen showed a full-looking list and simply had no
   * row for them. event_host_reminder is the one that matters most,
   * because it is the actual "remind the collective" press a host uses
   * every week.
   * Each defaultSubject below is copied from send-email's own subject
   * function. Keep them in step: saving a template unedited writes the
   * default here back as a real override row, so a stale copy silently
   * reinstates old wording (that is what the payment_failed em-dash was
   * about to do).
   * ------------------------------------------------------------------ */
  {
    ...
    defaultCtaLabel: 'View Event',
    defaultCtaUrl: '{{event_url}}',
    sampleData: { name: 'Alex', inviter_name: 'Sam', event_title: 'Byron Beach Clean-Up', event_date: 'Sat 5 Apr 2026', event_location: 'Byron Bay', event_url: 'https://app.coexistaus.org/events/test', custom_message: 'See you at 3pm!' },
  },
  {
    ...
    defaultSubject: "You're going: {{event_title}}",
    defaultEmoji: '\u{1F39F}',
    defaultHeroTitle: "You're Going!",
    defaultHeroSubtitle: '{{event_title}}',
    defaultCtaLabel: 'View Ticket',
    defaultCtaUrl: '{{ticket_url}}',
    sampleData: { name: 'Alex', event_title: 'Byron Beach Clean-Up', event_date: 'Sat 5 Apr 2026', event_location: 'Byron Bay', ticket_code: 'CX-1234', quantity: 1, amount: '25.00', currency: 'AUD', ticket_url: 'https://app.coexistaus.org/events/test' },
  },
  {
    type: 'ticket_spot_held',
    label: 'Spot Held (pay to confirm)',
    category: 'transactional',
    description: 'Organiser held a spot; payment still needed',
    defaultSubject: 'A spot is held for you: {{event_title}}',
    defaultEmoji: '\u{1F91D}',
    defaultHeroTitle: 'A Spot Is Held For You',
    defaultHeroSubtitle: '{{event_title}}',
    defaultCtaLabel: 'Pay to Confirm',
    defaultCtaUrl: '{{pay_url}}',
    sampleData: { name: 'Alex', event_title: 'Byron Beach Clean-Up', event_date: 'Sat 5 Apr 2026', event_location: 'Byron Bay', amount: '25.00', currency: 'AUD', hold_expires: 'Fri 4 Apr 2026', pay_url: 'https://app.coexistaus.org/events/test', reserved_by_name: 'Sam' },
  },
  {
    type: 'ticket_transferred',
    label: 'Ticket Moved',
    category: 'transactional',
    description: 'A leader moved this ticket to another event',
    defaultSubject: 'Your ticket has moved to {{event_title}}',
    defaultEmoji: '\u{1F504}',
    defaultHeroTitle: 'Your Ticket Has Moved',
    defaultHeroSubtitle: '{{event_title}}',
    defaultCtaLabel: 'View Event',
    defaultCtaUrl: '{{event_url}}',
    sampleData: { name: 'Alex', event_title: 'Byron Beach Clean-Up', event_date: 'Sat 5 Apr 2026', event_location: 'Byron Bay', previous_event_title: 'Coolum Clean-Up', ticket_code: 'CX-1234', event_url: 'https://app.coexistaus.org/events/test' },
  },
  {
    type: 'ticket_transfer_offer',
    label: 'Ticket Passed To You',
    category: 'transactional',
    description: 'Someone is transferring their ticket to you',
    defaultSubject: '{{from_name}} is passing you their ticket to {{event_title}}',
    defaultEmoji: '\u{1F3AB}',
    defaultHeroTitle: 'A Ticket For You',
    defaultHeroSubtitle: '{{event_title}}',
    defaultCtaLabel: 'Claim Ticket',
    defaultCtaUrl: '{{claim_url}}',
    sampleData: { name: 'Alex', from_name: 'Sam', event_title: 'Byron Beach Clean-Up', event_date: 'Sat 5 Apr 2026', event_location: 'Byron Bay', claim_url: 'https://app.coexistaus.org/events/test', expires: 'Fri 4 Apr 2026' },
  },
  {
    type: 'ticket_refunded',
    label: 'Ticket Refunded',
    category: 'transactional',
    description: 'Event ticket refunded',
    defaultSubject: 'Refund processed: {{event_title}}',
    defaultEmoji: '\u{1F4B8}',
    defaultHeroTitle: 'Refund Processed',
    defaultHeroSubtitle: '{{event_title}}',
    defaultCtaLabel: 'Browse Events',
    defaultCtaUrl: 'https://app.coexistaus.org/events',
    sampleData: { name: 'Alex', event_title: 'Byron Beach Clean-Up', event_date: 'Sat 5 Apr 2026', event_location: 'Byron Bay', ticket_code: 'CX-1234', refund_amount: '25.00', currency: 'AUD' },
  },
  {
    type: 'event_spot_released',
    label: 'Spot Released',
    category: 'transactional',
    description: 'A registration could not be honoured',
    defaultSubject: 'About your spot at {{event_title}}',
    defaultEmoji: '\u{1F4CB}',
    defaultHeroTitle: 'About Your Spot',
    defaultHeroSubtitle: '{{event_title}}',
    defaultCtaLabel: 'Browse Events',
    defaultCtaUrl: '{{next_events_url}}',
    sampleData: { name: 'Alex', event_title: 'Byron Beach Clean-Up', event_date: 'Sat 5 Apr 2026', event_location: 'Byron Bay', next_events_url: 'https://app.coexistaus.org/events' },
  },
  {
    type: 'waitlist_joined',
    label: 'Waitlist Joined',
    category: 'transactional',
    description: 'Joined the waitlist for a sold-out event',
    defaultSubject: "You're on the waitlist for {{event_title}}",
    defaultEmoji: '\u{23F3}',
    defaultHeroTitle: "You're On The Waitlist",
    defaultHeroSubtitle: '{{event_title}}',
    defaultCtaLabel: 'View Event',
    defaultCtaUrl: '{{event_url}}',
    sampleData: { name: 'Alex', event_title: 'Byron Beach Clean-Up', event_date: 'Sat 5 Apr 2026', position: 3, event_url: 'https://app.coexistaus.org/events/test' },
  },
  {
    type: 'waitlist_spot_open',
    label: 'Waitlist Spot Open',
    category: 'transactional',
    description: 'A ticket freed up on a sold-out event',
    defaultSubject: 'A spot just opened for {{event_title}}',
    defaultEmoji: '\u{1F513}',
    defaultHeroTitle: 'A Spot Just Opened',
    defaultHeroSubtitle: '{{event_title}}',
    defaultCtaLabel: 'Claim Your Spot',
    defaultCtaUrl: '{{event_url}}',
    sampleData: { name: 'Alex', event_title: 'Byron Beach Clean-Up', event_date: 'Sat 5 Apr 2026', event_url: 'https://app.coexistaus.org/events/test', hours_to_claim: 24 },
  },
  {
    type: 'upcoming_in_collective',
    label: 'Collective Re-engagement',
    category: 'marketing',
    description: "The next event in a lapsed member's collective",
    defaultSubject: "What's on with {{collective_name}}",
    defaultEmoji: '\u{1F331}',
    defaultHeroTitle: "What's On",
    defaultHeroSubtitle: '{{collective_name}}',
    defaultCtaLabel: 'See Details and RSVP',
    defaultCtaUrl: '{{event_url}}',
    sampleData: { name: 'Alex', collective_name: 'Sunshine Coast Collective', event_title: 'Byron Beach Clean-Up', event_date: 'Sat 5 Apr 2026', event_location: 'Byron Bay', event_url: 'https://app.coexistaus.org/events/test' },
  },
  {
    type: 'data-export-request',
    label: 'Data Export Request',
    category: 'transactional',
    description: 'Acknowledges a data export request',
    defaultSubject: 'Your data export request',
    defaultEmoji: '\u{1F4E6}',
    defaultHeroTitle: 'Data Export Requested',
    defaultHeroSubtitle: '',
    defaultCtaLabel: '',
    defaultCtaUrl: '',
    sampleData: { name: 'Alex', email: 'alex@example.com' },
  },
]
