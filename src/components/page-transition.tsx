...
export function PageTransition({ children }: PageTransitionProps) {
  ...
  if (reduce) {
    return (
      <Suspense data-eos-id="src/components/page-transition.tsx#0" data-eos-v="2" fallback={<div data-eos-id="src/components/page-transition.tsx#1" className="flex-1 min-h-0 bg-surface-1" />}>
