...
export interface AttendeeWithStatus {
  ...
  profiles: Pick<Profile, 'id' | 'display_name' | 'first_name' | 'last_name' | 'avatar_url' | 'phone' | 'age' | 'gender' | 'accessibility_requirements' | 'dietary_requirements' | 'medical_requirements' | 'emergency_contact_name' | 'emergency_contact_phone' | 'emergency_contact_relationship'> | null
}
